 ...
 */
package com.dxc.bankia.event.old.functions;
...
public class BaseKieContainer {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(com.dxc.bankia.event.functions.BaseKieContainer.class);
