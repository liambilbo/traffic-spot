...
import com.dxc.bankia.event.functions.ApplyPostfilter;
...
/**
 *
 * /opt/spark/bin/spark-submit --class com.dxc.bankia.event.pipes.EventEnrichmentPostfilterPipe usr/local/data/spark/SparkConsumer.jar kafka-broker:9092 DEFAULT
 *
 */
public class EventEnrichmentPostfilterPipe {
    ...
    public static void main(String[] args)  throws Exception {
        ...
        SparkSession sparkSession = SparkSession.builder().master("local[2]").appName("com.dxc.bankia.event.pipies.EventEnrichmentPostfilterPipe").config("spark.logConf","true").getOrCreate();
