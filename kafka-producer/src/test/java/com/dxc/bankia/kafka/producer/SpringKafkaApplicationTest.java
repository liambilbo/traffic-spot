...
@EmbeddedKafka(partitions = 1,
        topics = {SpringKafkaApplicationTest.CAT_TOPIC})
public class SpringKafkaApplicationTest {

    static final String CAT_TOPIC = "CatTopic";

    @Autowired
    private KafkaConsumerService receiver;
    ...
    public void testReceive() throws Exception {
        ...
        //sender.sendMessage(CAT_TOPIC,"Hello Spring Kafka!");


        System.out.println("Start auto");
        ContainerProperties containerProps = new ContainerProperties("CatTopic");
        ...
        template.setDefaultTopic("CatTopic");
